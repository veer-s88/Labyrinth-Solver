...
def draw_circle(mask, frame, setpoints):
...
def main():
    ...
    while True:
        ...
        blue_lower = np.array([78, 27, 58])
        blue_upper = np.array([157, 255, 200])
        ...
        if None in output_frame[1]:
            ...
            output = draw_circle(mask_ball, result, setPoints)
            ...
            cv2.putText(output[0], 'Current Ball coordinates: ' + str(output[1]), (530, 20), font, 0.4, (175, 0, 0),
                        1, cv2.LINE_AA)
            cv2.putText(output[0], 'Desired ball coordinates: ' + str(setPoints), (520, 40), font, 0.4, (175, 0, 0), 1,
                        cv2.LINE_AA)
            cv2.putText(output[0], 'Board Angle [x]: ' + str(angles[0]), (560, 60), font, 0.4, (175, 0, 0), 1,
                        cv2.LINE_AA)
            cv2.putText(output[0], 'Board Angle [y]: ' + str(angles[1]), (560, 80), font, 0.4, (175, 0, 0), 1,
                        cv2.LINE_AA)
